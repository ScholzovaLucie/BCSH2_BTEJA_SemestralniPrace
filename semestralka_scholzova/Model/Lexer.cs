...
namespace semestralka_scholzova.Model
{
    public class Lexer
    {
        ...
        private void Number()
        {
            ...
            if (isfloat)
            {
                tokens.Add(new Token(EnumTokens.FLOAT, source.Substring(start, aktrulaPosition - start), line, float.Parse(source.Substring(start, aktrulaPosition - start))));
            }
            else
            {
                tokens.Add(new Token(EnumTokens.INT, source.Substring(start, aktrulaPosition - start), line, int.Parse(source.Substring(start, aktrulaPosition - start))));
            }
